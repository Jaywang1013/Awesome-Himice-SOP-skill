...
负责项目执行落地、客户沟通、项目收支与跨部门协作。

## 部门专属 Skill

当前暂无。后续只服务项目执行或对客工作的技能放在本目录。

## 可调用的通用 Skill

| Skill | 本部门使用环节 | 来源 |
| --- | --- | --- |
| [操作费用报销](../../all-department/himice-expense-reimbursement-sop/SKILL.md) | 票据整理、报销、实际成本更新 | 全部门通用 |
| [项目预算](../../company-common/himice-budget-sop/SKILL.md) | 客户报价转项目预算 | 公司通用 |
